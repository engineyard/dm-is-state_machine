...
gem 'dm-core', "~> #{DM_VERSION}", SOURCE => "#{DATAMAPPER}/dm-core#{REPO_POSTFIX}", :tag => "v#{DM_VERSION}"
...
group :datamapper do
  ...
  plugins.each do |plugin|
    gem plugin, "~> #{DM_VERSION}", SOURCE => "#{DATAMAPPER}/#{plugin}#{REPO_POSTFIX}", :tag => "v#{DM_VERSION}"
  end
